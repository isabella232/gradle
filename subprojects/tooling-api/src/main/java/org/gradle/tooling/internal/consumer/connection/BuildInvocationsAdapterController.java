...
public class BuildInvocationsAdapterController extends AbstractBuildController {
    ...
    public BuildInvocationsAdapterController(ProtocolToModelAdapter adapter, VersionDetails versionDetails, BuildController delegate) {
    ...
    public <T> T getModel(Model target, Class<T> modelType) throws UnknownModelException {
        if (modelType.equals(BuildInvocations.class) && !versionDetails.maySupportModel(BuildInvocations.class)) {
